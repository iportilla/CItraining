"""
Adapted from Malicious URL classifier:
...
# SET THE NUMBER OF CPU CORES HERE!
...
df = pd.read_csv(os.path.join(DATA_HOME, 'url_data_mega_deep_learning.csv'))
print("Sample data:")
print(df.sample(n=25).head(25))
