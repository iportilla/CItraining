...
└── solutions/                            # Pre-trained models
    ...
    └── NN-episode-24-keras-classify-workbook-WS2025.ipynb # Workbook solution
```
...
```bash
# Use available launcher scripts or SLURM jobs
bash model_tuning_batch_hpc/scan-hidden-neurons/submit-scan-hidden-neurons.sh
bash model_tuning_batch_hpc/scan-learning-rate/submit-scan-learning-rate.sh
sbatch model_tuning_batch_hpc/solutions/Baseline_Model.slurm
sbatch model_tuning_batch_hpc/solutions/NN_Model_1H.slurm
```
